...
**A3: Keith Yearwood, who is an instructor for the Geographical Sciences department, has taught 58 classes.** 
...
**A4: Filtering out and excluding the classes that have no instructor listed (NA), isolating single names from classes that are taught by multiple professors, making sure that two people with the same name don't teach in the department** 
...
**A5: Question- which semester had the most classes offered for Business and Management ? The Fall 2022 semester which had 174 classes offered, which was an increase from 168 classes offered in the 2018 spring semseter.**
...
umd_courses %>%
  ...
  arrange (department, count_classes)
```