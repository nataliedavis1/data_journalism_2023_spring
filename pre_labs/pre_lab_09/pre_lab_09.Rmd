...
**Answer** Copy the url of the graphic you published here. It will begin with https://datawrapper.dwcdn.net/. Don't copy the browser's current url.**https://www.datawrapper.de/_/SX5HW/**
...
md_gov_county <- md_gov_county %>% 
  mutate (total_votes = Cox + Moore + Lashar + Harding + Wallace + `Write-ins`) %>%
...
**Answer** Describe the changes from the previous map **The new map only shows Maryland instead of the whole US**
...
**Answer** Describe the changes from the previous map **Now when you hover over different counties it will tell you their names and the percentage of votes that Moore recieved from that county**
...
**Answer** Put the URL of your map here. **https://www.datawrapper.de/_/gL2IC/**
