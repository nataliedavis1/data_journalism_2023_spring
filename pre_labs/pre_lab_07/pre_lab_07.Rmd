...
```{r echo=FALSE}
census_api_key("81402b378db7b8137c95c1f896a8ce6034c0394d", overwrite=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer: Nevada has the highest percentage change at approximately 35%**
...
**Answer: The county with the highest median household income is Howard County which came out to be almost about $129,500**
...
**Answer: Howard County is Maryland's richest county** 
...
Is the difference between Calvert and Montgomery significant? **Answer: Yes, there is overlap present here so we can't be 100% sure that one is above the other based on this estimate **

Is the difference between Howard and everyone else significant? **Answer: No, there is no overlap present here in the margin of errors **
...
**Answer: The largest increases in median income were Baltimore City, Allegany County, and Calvert County with each gaining approximately 37, 35 and 32% respectively.No counties saw their median income fall but Caroline County had the lowest increase being approximately 7%  **
...
**Answer: How does median household income affect the percentage of enrollment in college, is there a correlation? **
...
**Answer: The median average income for schools with 60% or more enrolled in college is over $40,000 more than in schools with less then 40% enrolled in college   **
...
**Answer:If we were able to add in racial data it would be interesting to see how the diversity of an area plays a role as well. ** 
