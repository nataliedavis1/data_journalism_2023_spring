...
**Answer: Adding a month column and then grouping the data set by month and summarizing the number of calls for each month. The last step orders the months by most frequently called during to least frequently called during. **
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer: Shows a bar graph of the months with each bar corresponding to that month's number of calls**
...
**Answer: Reorders the months to go in order from the least called month to the most called month (from left to right)**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer: The bar graph is flipped on so that the bars are horizontal as opposed to vertically. It is a bit easier to distinguish the lengths of each bar**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer: The background of the graph has changed from a lighter gray color to a white color **
...
**Answer: I installed the package :)**
...
**Answer: The background of the graphic is now light blue and the font style is a little bit different **
```{r}
baltco_911_calls_by_month %>%
  ggplot() +
  geom_bar(aes(x=reorder(month,total_calls), weight=total_calls)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer: There is a larger title added above the graph and each axis is labeled. There is also a caption that accredits the source at the bottom. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer: A data set that includes different dates starting from Feb 6,2022 and the number of calls associated with each date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer: A line graph of total calls by each day**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer: The dataset is broken down into smaller division lines by week**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer: The dates are angled and seperated a little more so that they are more readable**
```{r}
baltco_911_calls_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_calls)) + 
