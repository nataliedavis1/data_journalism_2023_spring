...
**Answer: Overtime the number of registered people has grown for all parties except the GRN party which has 74 less people in it. The number of Democrats has grown by 17,320 and the number of Republicans has grown by 3,374 ** 
...
**Answer: There are 24 rows and there should be 24 **
...
**Answer: It contains the population numbers of people over age 18 as well as groups of the population split up by race. There is also a total number of people with one race vs a group of two or more **
```{r}
...
**Answer: Prince George's county has a population that is approximately 60.9% black people over the age of 18 and 77% democratic, which is the highest.  **
...
**Answer: The counties with a higher asian population does not have a clear correlation to counties that have a higher percentage of democats. **
...
**Answer: It shows up as a <dbl> (number) column instead of a character column**
...
**Answer: It was changed to a <chr> character column **
