...
**Answer: The data has loaded and is presented in a format where we can read its contents. There are columns for the zipcodes, the length (boundaries) of the zipcodes and the areas they cover, as well as a column to portray the full shape.**
...
**Answer:The one that is new to me is the geometry column which contains the code behind how to draw the shape digitally**
...
**Answer: A base zip code map that shows outlines of the Maryland zip code areas**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: The package Tigris is installed and loaded. **
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: There is a data set retrieved shows all the US counties **
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: It created a new data frame with Maryland counties**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: The outline of all the counties in Maryland. There is no Chesapeake Bay in this representation of the state**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: A outline of teh counties, with the zip codes added in, it is hard to distinguish where the lines are though **
...
**Task** Run the following code. Describe the output in the space below.
**Answer: A dataset containing information on foreclosures and ther zip codes** 
...
**Task** Run the following code. Describe the output in the space below.
**Answer: A joined data frame wth zip code and foreclosure data**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer:The chart is colored in by the number of foreclosures in each zip code. Some areas in Prince George's county appear to be very light and stand out here. **
...
**Answer: Loads the data librarys we need**
...
library(janitor)
library(tidycensus)
census_api_key("81402b378db7b8137c95c1f896a8ce6034c0394d", install=TRUE, overwrite=TRUE)
```
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Creates a new data frame to show the foreclosure notices**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Retrieves data frame from the census website and makes a new dataframe**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Lets us take a look at the county population and foreclosure notices data frames so we can see what data they include**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: shows just the county, population and geometry columns**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Combines the data frames together**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Adds columns to calculate rates**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: A graph reflecting each county and its corresponding rate**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer: Changes the colors to make them more distinguishable**
...
**Answer: changes the colors again to make them very distinct so that they stand out even more from one another.One of the biggest regional patterns is that central Maryland is very purple**
