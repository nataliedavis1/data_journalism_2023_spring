...
**Answer: A dataframe containing information on the releases including dates and titles and links to them **
...
**Answer: Condenses it so that each unique value shows up only once in the list**
...
**Answer: Each unique value is seperated into a different row in the dataframe**
...
**Answer: It shows the most frequently used words. Most of the words are basic and not super interesting but its cool that Maryland is in there. **
...
**Answer: It definitely is more interesting! There are words that seem to be addressing actual issues at hand. **
...
**Answer: There are dataframes created with the top ten words for 2021, 2022 and 2023 respectively**
...
**Task** Run the following code and describe the results.
**Answer: The dataframe contains the ten most common phrases that contain two words for the year 2021**
...
**Task** Run the following code and describe the results.
**Answer: The dataframe contains the ten most common phrases that contain two words for the year 2022**
...
**Task** Run the following code and describe the results.
**Answer: The dataframe contains the ten most common phrases that contain two words for the year 2023**
...
**Answer: The sentiments found here are positive for the most part. I believe they are pretty accurate, they don't seem too incorrect or counter-intuitive in my opinion. **
