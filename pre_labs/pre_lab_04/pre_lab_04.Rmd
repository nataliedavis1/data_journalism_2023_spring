...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer: There are a lot of grantees that are probably the same but aren't grouped together: Example (Washington co commisione and Washington co commisioners are listed as seperate grantees)**
...
**Answer: Washington county museum of fine arts was changed to all caps and Charles County Arts Alliance Inc had the inc dropped from its name and also was changed to all caps**
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer: Washinton County Community action council and Washinton County Community action council Inc became the same thing, Way station and Way station Inc became the same,Westminster fire engine & hose co became the same as Westminster Fire Engine and Hose company  **
...
**Answer: There are some changes but not hugely substantial**
