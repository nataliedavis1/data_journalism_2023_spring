...
This notebook contains code and explanatory text that you should review and run as you read through chapters 13 and 15 of the course textbook, "Data Journalism with R and the Tidyverse". Answer questions and edit the document as directed.
...
**Answer: 55632 obs of 7 variables **
...
**Answer: Starting within the dataframe, the code shows all the possible different terms once and then counts up the number of classes that were listed as being available during that term **
...
**Answer: The terms with the most classes available are shown first followed by terms with less classes available (in order). This affected the result because the data is not in chronological order by term anymore. **
...
**Answer: Now the data is in order by term and then alphabetically by department. This is because the group-by code's parenthesis changed from (term) to (term, department) **
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer: The number of seats available in each term were added as a new category to count up and this made a new column in the table shown**
...
**Answer: The calculations of mean number of seats per term and median number of seats were added. The top terms are all 08 terms. **
...
**Answer: In this code, it is changed to being sorted by department as opposed to by term **
...
1.  Why is the minimum number of seats 0? 

2.  Why do some departments have over 100 mean seats and some have in the 20-30 range? 

3.  Why is Air science an outlier with 97 median seats? 
