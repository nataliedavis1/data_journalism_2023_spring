...
**Task** Run the following codeblock to reload the data, using every row to set the data types. Does it show any parsing errors when you run? Answer below **Answer: No, it didn't show up with any warnings/parsing errors**
...
**Task** Run the following codeblock to glimpse the data. What data type is the "district" field? What data type is the "precinct" field? What data type is the "mail" column? Answer below. **Answer: Skipped **
...
**Answer: There are 547 zip codes that have less then 5 digits.They are from locations that are not standardized to the 5 digit zip code because most likely the leading zeros have been cut off from the data set **
...
**Task** Run the following codeblock to count the number of payments. Looking at the result, what jumps out at you as potentially problematic? **Answer: There are some results that have NA as their categories and others listed as 'L' or 'Contract' **
...
**Answer: The smallest amount in this data set is listed as $60 which could be an interesting outlier to look into. **
...
**Task** Run the following codeblock to check for duplicate rows using get_dupes(). How many duplicates are possible? **Answer: There are 50 possible duplicate rows **
...
**Task** Run the following codeblock to use distinct() to get rid of duplicate rows. How many rows does the new dataframe have? Answer below. **Answer: 17,740 rows are contained within the new dataframe, which is 25 less than the original data set**
...
**Task** Run the following codeblock to use str_sub() to convert the ZIP codes that have nine digits to five digits, creating a new column. Look at the difference in the result - what changed? **Answer:The first five digits of the longer zip codes are contained within the new column zip5 at the end of the dataset **
...
**Answer: The zip code 20001 has the highest amount of money with a little over $5 billion dollars.This zip code corresponds to Washington DC. **
