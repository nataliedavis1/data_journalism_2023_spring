...
voters_by_county_cleaned <- voters_by_county %>%
  clean_names()
voters_by_county_cleaned <- voters_by_county_cleaned %>% slice (-25)
```
...
**Answer: We still don't have the years as the data column names**
...
**Answer: Remove the dotted lines from the end of each jurisdiction name **
