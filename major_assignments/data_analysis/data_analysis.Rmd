...
# The correlation number here shows that there is not a signicant correlation between the two categories.
...
correlation_df_minuteval <- spotify_youtube %>%
  ...
  filter(!is.na(minute_run)) %>%
   mutate(correlation = cor (valence, minute_run))


correlation <- cor(correlation_df_minuteval$valence, correlation_df_minuteval$minute_run)
